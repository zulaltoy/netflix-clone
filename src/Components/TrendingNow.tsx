...
const TrendingNow = () => {
    return (
        <div className="px-6 py-8 bg-gray-600">
            <h3 className="font-bold text-2xl p-2 text-white">Trending Now</h3>
            <div>
                {TREND_DATA?.results?.length > 0 ? (
                    <MovieList movies={TREND_DATA.results} />
                ) : (
